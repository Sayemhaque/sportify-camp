...
const Categories = () => {
    return (
        <div className="grid grid-cols-2 md:grid-cols-3 gap-5 place-items-center py-12">
            ...
            <div className="bg-gray-200 p-6">
               <img className="w-[100px] hover:rotate-90 cursor-pointer duration-500" src={Basketball} alt="" />
            </div>
        </div>
    );
};
