            ...
            <div className="navbar md:max-w-6xl mx-auto">
                <div className="navbar-start">
                    <div className="dropdown ">
                        ...
                        <ul tabIndex={0} className={`menu menu-md font-bold dropdown-content mt-3 p-2 shadow z-50  rounded-box w-[200px] h-[200px] ${isDarkMode ?
                             " bg-slate-900 text-white" : "bg-gray-200"}`}>
                            {navLinks}
                        </ul>
                    </div>
                    {/* website name */}
