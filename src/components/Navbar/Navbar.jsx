...
const Navbar = () => {
    ...
    const user = false;
    return (
        <div className="navbar bg-orange-300 shadow-lg">
            <div className="navbar md:max-w-6xl mx-auto">
                <div className="navbar-start">
                    ...
                    {/* website name */}
                    <a className="btn btn-ghost normal-case md:text-3xl font-bold font-serif">SportifyCamp</a>
                </div>
                <div className="navbar-center  hidden lg:flex">
                    <ul className="menu  font-bold text-[16px]  menu-horizontal px-1">
                        {navLinks}
                    </ul>
                </div>
