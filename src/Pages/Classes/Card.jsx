...
const Card = ({Class }) => {
  ...
  <div className="card-body">
   ...
   <p className="font-bold text-xl">{instructor}</p>
    ...
    <div className="mt-4">
    <button className={`bg-white px-5 py-2 font-bold  rounded-md disabled:bg-opacity-60 disabled:cursor-not-allowed ${isDarkMode ? "text-black" : ""}`} disabled={!student} onClick={handleSelect}>
    Select
    </button>
  </div>
  </div>
